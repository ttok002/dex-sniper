...
task(
  ...
  .addPositionalParam('amountIn', 'Amount of tokens you wish to sell (formatted, not BigNumber)')
  ...
  .setAction(async ({ dexName, amountIn, token0, token1, digits0, digits1 }, hre) => {
